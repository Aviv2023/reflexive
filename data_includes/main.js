...
Template("refl_fillers.csv", row =>
    ...
    ,
       ...
       newController("Question", {q: row.question, as: ["לא","כן"]})
            ...
            .log()
        ,
        newTimer("timeout_filler", 10000)
            .start()
            .log()
        ,
        newKey("answer_filler", "FJ")
            .callback( getTimer("timeout_filler").stop() )
            .log("all")
        ,
        
        getTimer("timeout_filler")
            .wait()
        ,
